...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{l l >{\raggedleft}X l}
        分类号：           & \underline{TP301.6}  &
        单位代码：         & \uline{\hfill 10335 \hfill} \\
        密{\quad}级：      & \underline{无} &
        学{\quad\quad}号： & \underline{22060535}
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{1.1\textwidth}{>{\fangsong}l X<{\centering}}
        ...
        {
            % TitleLines == 2
            中文论文题目：&  \uline{ \fangsong \TitleLineOne{} \hfill} \\
            ~            & \uline{ \fangsong \TitleLineTwo{} \hfill} \\
        }
        ...
        {
            % TitleEngLines == 2
            英文论文题目：&  \uline{ \TitleEngLineOne{} \hfill} \\
            ~            & \uline{\TitleEngLineTwo{} \hfill} \\
        }
    \end{tabularx}
\end{center}
